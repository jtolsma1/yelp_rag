...
import pandas as pd
import requests
from src.emit_util import emit
...
class SummarizeRelevantReviewText:
    ...
    def retrieve_relevant_text_summaries_from_ollama(self,relevant_chunk_df,restaurant_ids,status_cb = None):
        """
        ...
        emit(status_cb,{"type":"done","total":total,"message":"Restaurant summarization complete"})

        return summary_df

    def summarize_relevant_review_text(self,status_cb = None):
        """
